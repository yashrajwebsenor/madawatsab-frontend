 ...
 *
 * Pass `enabled: false` to hold the fetch off (e.g. while the user is still
 * behind the entry-fee gate — the rooms API would 403).
 */
const useChatRooms = (options?: { enabled?: boolean }) => {
